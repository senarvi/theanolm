...
# -*- coding: utf-8 -*-
#
# TheanoLM documentation build configuration file, created by
# sphinx-quickstart on Tue Apr 26 12:28:03 2016.
#
...
latex_documents = [
  ('index', 'TheanoLM.tex', 'TheanoLM Documentation',
   'Seppo Enarvi', 'manual'),
]
...
man_pages = [
    ('index', 'theanolm', 'TheanoLM Documentation',
     ['Seppo Enarvi'], 1)
]
...
texinfo_documents = [
  ('index', 'TheanoLM', 'TheanoLM Documentation',
   'Seppo Enarvi', 'TheanoLM', 'One line description of project.',
   'Miscellaneous'),
]
