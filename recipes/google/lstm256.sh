...
mv -f "${script_dir}/lstm256.log" "${script_dir}/lstm256.log~" 2>/dev/null || true
train | tee "${script_dir}/lstm256.log"

compute_perplexity | tee --append "${script_dir}/lstm256.log"
