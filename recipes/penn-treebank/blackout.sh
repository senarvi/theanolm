...
mv -f "${script_dir}/blackout.log" "${script_dir}/blackout.log~" 2>/dev/null || true
train | tee "${script_dir}/blackout.log"
compute_perplexity | tee --append "${script_dir}/blackout.log"
