...
mv -f "${script_dir}/nesterov.log" "${script_dir}/nesterov.log~" 2>/dev/null || true
train | tee "${script_dir}/nesterov.log"
compute_perplexity | tee --append "${script_dir}/nesterov.log"
