...
mv -f "${script_dir}/blackout-shared.log" "${script_dir}/blackout-shared.log~" 2>/dev/null || true
train | tee "${script_dir}/blackout-shared.log"
compute_perplexity | tee --append "${script_dir}/blackout-shared.log"
