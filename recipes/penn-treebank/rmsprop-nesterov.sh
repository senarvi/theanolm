...
mv -f "${script_dir}/rmsprop-nesterov.log" "${script_dir}/rmsprop-nesterov.log~" 2>/dev/null || true
train | tee "${script_dir}/rmsprop-nesterov.log"
compute_perplexity | tee --append "${script_dir}/rmsprop-nesterov.log"
