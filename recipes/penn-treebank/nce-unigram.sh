...
mv -f "${script_dir}/nce-unigram.log" "${script_dir}/nce-unigram.log~" 2>/dev/null || true
train | tee "${script_dir}/nce-unigram.log"
compute_perplexity | tee --append "${script_dir}/nce-unigram.log"
