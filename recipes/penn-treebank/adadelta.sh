...
mv -f "${script_dir}/adadelta.log" "${script_dir}/adadelta.log~" 2>/dev/null || true
train | tee "${script_dir}/adadelta.log"
compute_perplexity | tee --append "${script_dir}/adadelta.log"
