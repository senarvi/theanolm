...
OPTIMIZATION_METHOD=rmsprop-sgd
MAX_GRADIENT_NORM=5
...
mv -f "${script_dir}/rmsprop-sgd.log" "${script_dir}/rmsprop-sgd.log~" 2>/dev/null || true
train | tee "${script_dir}/rmsprop-sgd.log"
compute_perplexity | tee --append "${script_dir}/rmsprop-sgd.log"
