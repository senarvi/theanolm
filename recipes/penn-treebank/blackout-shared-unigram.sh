...
#mv -f "${script_dir}/blackout-shared-unigram.log" "${script_dir}/blackout-shared-unigram.log~" 2>/dev/null || true
#train | tee "${script_dir}/blackout-shared-unigram.log"
compute_perplexity | tee --append "${script_dir}/blackout-shared-unigram.log"
