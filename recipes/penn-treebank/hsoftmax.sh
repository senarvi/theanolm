...
mv -f "${script_dir}/hsoftmax.log" "${script_dir}/hsoftmax.log~" 2>/dev/null || true
train | tee "${script_dir}/hsoftmax.log"
compute_perplexity | tee --append "${script_dir}/hsoftmax.log"
